<%@ Page language="c#" Codebehind="wfmModifyChance.aspx.cs" AutoEventWireup="false" Inherits="VCustApp.BusinessChance.wfmModifyChance" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmModifyChance</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table align="center">
				<tr>
					<td colspan="2">
						<asp:Label id="Label1" runat="server" style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033">修改商机</asp:Label></td>
				</tr>
			</table>
			<table align="center">
				<tr>
					...
					<td>
						<asp:DropDownList id="ddlDept" runat="server" AutoPostBack="True"></asp:DropDownList>
				...
				<tr>
					...
					<td>
						<asp:DropDownList id="ddlChanceType" runat="server" AutoPostBack="True"></asp:DropDownList>
				...
				<tr>
					...
					<td>
						<asp:TextBox id="txtCustName" runat="server"></asp:TextBox><INPUT id="btnSelected" type="button" value="关联客户" onclick="ShowHide('1',null);return false;"></td>
				</tr>
				<tr>
					<td>
						<asp:Label id="Label13" runat="server">商机时间：</asp:Label></td>
					<td>
						<asp:TextBox id="txtChanceDate" runat="server" onfocus="calendar()"></asp:TextBox></td>
				</tr>
				<tr>
					<td>
						<asp:Label id="Label6" runat="server">预测收入（万元）：</asp:Label></td>
					<td>
						<asp:TextBox id="txtForecastIncome" runat="server"></asp:TextBox></td>
				</tr>
				<tr>
					<td>
			...
			<div id="xMsg11" onmousedown="getFocus(this)">
				...
				<div id="xMsg31">
					<table align="center">
						<tr>
							<td><asp:Label id="Label11" runat="server">客户ID：</asp:Label></td>
						...
						<tr>
							<td>
								<asp:Label id="Label12" runat="server">客户名称：</asp:Label></td>
							<td>
