<%@ Page language="c#" Codebehind="wfmAddChance.aspx.cs" AutoEventWireup="false" Inherits="VCustApp.BusinessChance.wfmAddChance" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmAddChance</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table align="center">
				<tr>
					<td colspan="2">
						<asp:Label id="Label1" runat="server" style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033">添加商机</asp:Label></td>
				</tr>
			</table>
			<table align="center">
				<tr>
					...
					<td>
						...
						<asp:TextBox id="txtCustID" runat="server" Visible="False"></asp:TextBox></td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<asp:TextBox id="txtCustName" runat="server"></asp:TextBox><INPUT type="button" value="关联客户" onclick="ShowHide('1',null);return false;" id="btnSelected"></td>
				<tr>
					<td>
