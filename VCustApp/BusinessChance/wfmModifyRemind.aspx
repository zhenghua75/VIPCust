<%@ Page language="c#" Codebehind="wfmModifyRemind.aspx.cs" AutoEventWireup="false" Inherits="VCustApp.BusinessChance.wfmModifyRemind" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmModifyRemind</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table align="center">
				<tr>
					<td colspan="2">
						<asp:Label id="Label1" runat="server" CssClass="title">修改提醒</asp:Label></td>
				</tr>
			</table>
			<table align="center">
				<tr>
