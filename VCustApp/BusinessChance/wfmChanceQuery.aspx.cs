...
namespace VCustApp.BusinessChance
{
	...
	/// </summary>
	public class wfmChanceQuery : wfmBase
	{
		...
		protected System.Web.UI.WebControls.Button btnAddChance;
		protected System.Web.UI.WebControls.Button btnLoadChance;
		...
		private void BindGrid()
		{
			...
			strSql += " where a.cnvcDeptID like '"+ddlDept.SelectedValue+"' and isnull(a.cnvcMgr,'') like '"+ddlMgr.SelectedValue+"' ";
			strSql += " and a.cnvcChanceType like  '"+ddlChanceType2.SelectedValue+"'";
			strSql += " and isnull(a.cnvcTradeMgr,'') like '"+ddlTradeMgr.SelectedValue+"'";
		...
		{    
			...
			this.btnAddChance.Click += new System.EventHandler(this.btnAdd_Click);
			this.DataGrid1.ItemCommand += new System.Web.UI.WebControls.DataGridCommandEventHandler(this.DataGrid1_ItemCommand);
			this.DataGrid1.PageIndexChanged += new System.Web.UI.WebControls.DataGridPageChangedEventHandler(this.DataGrid1_PageIndexChanged);
			this.DataGrid1.DeleteCommand += new System.Web.UI.WebControls.DataGridCommandEventHandler(this.DataGrid1_DeleteCommand);
			this.DataGrid1.ItemDataBound += new System.Web.UI.WebControls.DataGridItemEventHandler(this.DataGrid1_ItemDataBound);
			this.btnLoadChance.Click += new System.EventHandler(this.btnLoadChance_Click);
...
//		}
		...
		private void DataGrid1_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			try
			{
				if(!e.Item.Cells[9].Text.Equals("否"))
		...
		private void DataGrid1_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			{								
				LinkButton btnDelete = (LinkButton)(e.Item.Cells[16].Controls[0]);
		...
		private void btnLoadChance_Click(object sender, System.EventArgs e)
		{
			this.Response.Redirect("../wfmFileUp.aspx?XlsType=Chance");
		}
	}
}
