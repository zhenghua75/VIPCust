<%@ Page language="c#" Codebehind="wfmModifyPlan.aspx.cs" AutoEventWireup="false" Inherits="VCustApp.BusinessChance.wfmModifyPlan" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmModifyPlan</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table align="center">
				<tr>
					<td colspan="2">
						<asp:Label id="Label1" runat="server" CssClass="title">修改销售计划</asp:Label></td>
				</tr>
			</table>
			<table align="center">
				<tr>
