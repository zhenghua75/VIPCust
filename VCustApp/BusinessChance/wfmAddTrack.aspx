<%@ Page language="c#" Codebehind="wfmAddTrack.aspx.cs" AutoEventWireup="false" Inherits="VCustApp.BusinessChance.wfmAddTrack" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmAddTrack</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table align="center">
				<tr>
					<td colspan="2">
						<asp:Label id="Label1" runat="server" CssClass="title">添加跟踪记录</asp:Label></td>
				</tr>
			</table>
			<table align="center">
				<tr>
