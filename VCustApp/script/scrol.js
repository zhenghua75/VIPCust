	// 自动滚动 
	/*<div  id="c" style="overflow:hidden;height:100px;width:800px; margin:0 auto;">  
			<div id="c1">  
			<iframe src="../script/购买影响因素表注意事项.htm" id="the_frame" width="100%" height="100%"
  					onload="this.height=the_frame.document.body.scrollHeight" 
  					></iframe>
			</div>  
			<div id="c2"></div> 
			</div>  
