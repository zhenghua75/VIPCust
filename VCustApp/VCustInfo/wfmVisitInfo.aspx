	...
	<body MS_POSITIONING="GridLayout" bgcolor="#f2f8fb">
		<FORM id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="5" width="95%" border="0" align="center">
				<TR>
					<TD align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033">拜访跟踪</TD>
				</TR>
			</TABLE>
				...
				<tr>
					<td>
						<TABLE id="Table2" cellSpacing="0" cellPadding="1" width="100%" border="0">
							<TR>
								<TD style="WIDTH: 160px; HEIGHT: 25px" align="right"><asp:label id="Label1" runat="server" Width="59px" Font-Size="10pt">客户编号</asp:label></TD>
								...
								<TD style="WIDTH: 97px; HEIGHT: 25px" align="right">
									<asp:label id="Label2" runat="server" Font-Size="10pt" Width="59px">客户名称</asp:label></TD>
								<TD style="WIDTH: 159px; HEIGHT: 25px"><FONT face="宋体">
										<asp:TextBox id="txtCustName" runat="server" Width="176px"></asp:TextBox></FONT></TD>
								<td style="WIDTH: 83px; HEIGHT: 25px" align="right"></td>
								<TD style="WIDTH: 78px; HEIGHT: 25px"><FONT face="宋体"></FONT></TD>
								<TD style="HEIGHT: 25px">
									<asp:button id="btnQuery" runat="server" Width="64px" Text="查询"></asp:button></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 160px" align="right">
									<asp:label id="Label3" runat="server" Font-Size="10pt" Width="70px">项目名称</asp:label></TD>
				...
				<TR>
					<TD align="center"><asp:datagrid id="DataGrid1" runat="server" AutoGenerateColumns="False" Font-Names="Verdana" Width="100%"
							...
							<Columns>
								...
								<asp:BoundColumn Visible="False" DataField="cnnProjectID" ReadOnly="True" HeaderText="项目编号"></asp:BoundColumn>
								<asp:BoundColumn DataField="cnvcProjectName" ReadOnly="True" HeaderText="项目名称"></asp:BoundColumn>
								<asp:BoundColumn DataField="cnvcMgr" ReadOnly="True" HeaderText="客户经理/行业经理"></asp:BoundColumn>
								<asp:ButtonColumn Text="拜访记录" HeaderText="查看" CommandName="Select"></asp:ButtonColumn>
							</Columns>
