<%@ Page language="c#" Codebehind="wfmAddAdvancePayment.aspx.cs" AutoEventWireup="false" Inherits="VCustApp.SalesManage.wfmAddAdvancePayment" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmAddAdvancePayment</title>
	...
	<body MS_POSITIONING="GridLayout" >
		<form id="Form1" method="post" runat="server">
			<table align="center">
				<tr>
					<td colspan="2">
						<asp:Label id="Label1" runat="server" style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033">添加预收账款</asp:Label></td>
				</tr>
			</table>
			<table align="center">
				<tr>
