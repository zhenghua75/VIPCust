<%@ Page language="c#" Codebehind="wfmAddAccountReceivable.aspx.cs" AutoEventWireup="false" Inherits="VCustApp.SalesManage.wfmAddAccountReceivable" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmAddAccountReceivable</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table align="center">
				<tr>
					<td colspan="2">
						<asp:Label id="Label1" runat="server" style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033">添加应收</asp:Label></td>
				</tr>
			</table>
			<table align="center">
				<tr>
				...
				<tr>
					<td>
						<asp:Label id="Label14" runat="server">一级行业属性：</asp:Label></td>
					<td>
						<asp:DropDownList id="ddlTradeType1" runat="server"></asp:DropDownList></td>
				</tr>
				<tr>
					<td>
						<asp:Label id="Label15" runat="server">二级行业属性：</asp:Label></td>
					<td>
						<asp:DropDownList id="ddlTradeType2" runat="server"></asp:DropDownList></td>
				</tr>
				<tr>
					<td>
						<asp:Label id="Label16" runat="server">客户等级：</asp:Label></td>
					<td>
						<asp:DropDownList id="ddlCustLevel" runat="server"></asp:DropDownList></td>
				</tr>
				<tr>
					<td>
						<asp:Label id="Label9" runat="server">合同编号：</asp:Label></td>
					<td>
				...
				<TR>
					<TD>
						<asp:Label id="Label6" runat="server">客户卡号：</asp:Label></TD>
					<TD>
				...
				<tr>
					<td>
						<asp:Label id="Label5" runat="server">业务种类</asp:Label></td>
					<td>
						<asp:TextBox id="txtSvcTypeName" runat="server"></asp:TextBox></td>
				</tr>
				<tr>
					<td>
						<asp:Label id="Label12" runat="server">收入（万元）：</asp:Label></td>
					<td>
						<asp:TextBox id="txtFee" runat="server"></asp:TextBox></td>
				</tr>
				<tr>
					<td colspan="2" align="center">
						<asp:Button id="btnOK" runat="server" Text="添加"></asp:Button>
