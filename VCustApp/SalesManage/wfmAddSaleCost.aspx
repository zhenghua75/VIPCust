<%@ Page language="c#" Codebehind="wfmAddSaleCost.aspx.cs" AutoEventWireup="false" Inherits="VCustApp.SalesManage.wfmAddSaleCost" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmAddSaleCost</title>
...
//-->
	...
	<body MS_POSITIONING="GridLayout" topmargin="200">
		<form id="Form1" method="post" runat="server">
			<table align="center">
				<tr>
					<td colspan="2">
						<asp:Label id="Label1" runat="server" style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033">添加销售成本</asp:Label></td>
				</tr>
			</table>
			<table align="center">
				<tr>
					...
					<td>
						...
						<asp:TextBox id="txtCustID" runat="server" Visible="False"></asp:TextBox><INPUT id="btnSelected" onclick="ShowHide('1',null);return false;" type="button" value="关联客户"></td>
				</tr>
				<tr>
					<td>
						<asp:Label id="Label2" runat="server">年份：</asp:Label></td>
					<td>
						<asp:DropDownList id="ddlYear" runat="server" Width="136px" Font-Size="10pt"></asp:DropDownList></td>
				</tr>
				<tr>
					<td>
						<asp:Label id="Label3" runat="server">预算销售成本：</asp:Label></td>
					<td>
						<asp:TextBox id="txtBudgetCost" runat="server"></asp:TextBox>
						<asp:Label id="Label14" runat="server">万元</asp:Label></td>
				</tr>
				<tr>
					<td>
						<asp:Label id="Label9" runat="server">实际销售成本合计：</asp:Label></td>
					<TD>
						<asp:TextBox id="txtRealSaleCost" runat="server"></asp:TextBox>
						<asp:Label id="Label15" runat="server">万元</asp:Label></TD>
				<tr>
					<td colspan="2" align="center">
						<asp:ImageButton id="btnOK" runat="server" ImageUrl="../image/btnOk.gif"></asp:ImageButton>
						<asp:ImageButton id="btnCance" runat="server" ImageUrl="../image/btnCancel.gif"></asp:ImageButton></td>
				</tr>
			</table>
