<%@ Page language="c#" Codebehind="wfmModifyAccountReceivable.aspx.cs" AutoEventWireup="false" Inherits="VCustApp.SalesManage.wfmModifyAccountReceivable" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmModifyAccountReceivable</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table align="center">
				<tr>
					<td colspan="2">
						<asp:Label id="Label1" runat="server" style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033">修改应收</asp:Label></td>
				</tr>
			</table>
			<table align="center">
				<tr>
					...
					<td>
						...
						<INPUT id="btnSelected" onclick="ShowHide('1',null);return false;" type="button" value="关联客户" style="display:none"></td>
				</tr>
				<tr>
					<td>
