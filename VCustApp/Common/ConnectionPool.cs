...
namespace VCustApp.Common
{
    ...
    public sealed class ConnectionPool : ObjectPool
    {
        ...
        {
			//未加密连接串
//			string _connectionStringSet = VCustApp.Common.ConfigAdapter.GetConfigNote("SetConnectionString").Trim();
//			if(String.Empty != _connectionStringSet)
//			{
//				_connectionStringSet = VCustApp.Common.DataSecurity.Encrypt(_connectionStringSet);
//				VCustApp.Common.ConfigAdapter.SetConfigNote("ConnectionString",_connectionStringSet);
//                VCustApp.Common.ConfigAdapter.SetConfigNote("SetConnectionString", String.Empty);
//			}
			
            _connectionString = VCustApp.Common.ConfigAdapter.GetConfigNote("ConnectionString");
			//_connectionString = VCustApp.Common.DataSecurity.Decrypt(_connectionString);
        }
        #endregion
